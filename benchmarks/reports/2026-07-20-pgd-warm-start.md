...
- Date: 2026-07-20
- Experimental code and protocol:
  [`research/pgd-worst-margin-warmstart`](https://github.com/vtjeng/MIPVerify.jl/tree/research/pgd-worst-margin-warmstart)
- Implementation commit:
  [`f7e2bec107f4155b84a6d69a04cfda9be950217b`](https://github.com/vtjeng/MIPVerify.jl/commit/f7e2bec107f4155b84a6d69a04cfda9be950217b)
...
corresponding treatment. The complete protocol and decision thresholds are in the
[research-branch protocol](https://github.com/vtjeng/MIPVerify.jl/blob/research/pgd-worst-margin-warmstart/benchmarks/README.md#decision-rules-and-definition-of-done).
